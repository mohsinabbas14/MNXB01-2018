...
#
# Datastructure format is ____JSON________________
...
wget http://fortunecookieapi.herokuapp.com/v1/fortunes -P/$FTTEMPDIR
...
NUMSG=$(wc -l /$FTTEMPDIR/fortunes_messages |cut -d'/' -f1)
